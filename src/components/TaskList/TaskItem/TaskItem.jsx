    ...
    return (
        ...
        >
            <span className="d-flex align-items-center flex-wrap">
                ...
                {description}
                {date ? <small className="ms-2">(Срок: {clearDate})</small> : null}
            </span>
            <button
                onClick={() => deleteTask(id)}
                className="btn btn-sm btn-outline-danger"
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" fill="currentColor" className="bi bi-trash3-fill" viewBox="0 0 16 16">
